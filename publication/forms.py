...
class PubAdditionForm(forms.Form):
    ...
    doi = forms.CharField(max_length=31, required=False)
    ...
    thesaurus_terms_keywords = forms.CharField(widget=forms.Textarea, required=False)
    controlled_terms_keywords = forms.CharField(widget=forms.Textarea, required=False)
    uncontrolled_terms_keywords = forms.CharField(widget=forms.Textarea, required=False)